...
var ASM_CONSTS = {
  7160288: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 7160349: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 7160413: function() {return Module.webglContextAttributes.powerPreference;},  
 7160471: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 7160526: function($0) {performance.now = function() { return $0; };},  
 7160574: function($0) {performance.now = function() { return $0; };},  
 7160622: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _ConnectWallet(){
          ...
          tonConnectInstance.connectWallet().then(result => {
              console.log("Connect wallet result:", result);
              unityInstanceRef.SendMessage('TonConnectManager', 'OnConnectedWallet', JSON.stringify(result));
          }).catch(error => {
              unityInstanceRef.SendMessage('TonConnectManager', 'OnError', JSON.stringify(error));
          });
      }
  ...
  function _DisconnectWallet(){
          ...
          tonConnectInstance.disconnectWallet().then( successed => {            
              unityInstanceRef.SendMessage('TonConnectManager', 'OnDisConnectedWallet', JSON.stringify(successed));  
          }).catch(error => {
              unityInstanceRef.SendMessage('TonConnectManager', 'OnError', JSON.stringify(error));
          })
      }

  function _GetGameHighScores(userIdPtr, chatIdPtr, messageIdPtr){
      if (TelegramBotInstance === null) {
        console.error("Bot instance is not initialized.");
        return;
      }
  
      console.log("GET GAME High score");
        var userId = parseInt(UTF8ToString(userIdPtr));
        var chatId = parseInt(UTF8ToString(chatIdPtr));
        var messageId = parseInt(UTF8ToString(messageIdPtr));
        
        console.log("User ID:", userId);        
        console.log("Chat ID:", chatId);
        console.log("Message ID:", messageId);
        
        TelegramBotInstance.getGameHighScores(userId, chatId, messageId ).then( result => {
            console.log( "Get high score: ", result );
            unityInstanceRef.SendMessage("TelegramBotManager", "OnGetGameHighScores", JSON.stringify(result));  
        }).catch(error => {
            console.error("Failed to set score:", error);
            unityInstanceRef.SendMessage("TelegramBotManager", "OnError", JSON.stringify(error));  
        });
    }
  ...
  function _IsConnectWallet() {
          console.log("Start IsConnectWallet");
          tonConnectInstance.isConnectWallet().then( connect => {
              console.log("Is Connected Wallet Result: ", connect);
              unityInstanceRef.SendMessage('TonConnectManager', 'OnIsConnectWallet', JSON.stringify(connect));  
          } ).catch(error => {
              console.log("IsConnectWallet Error: ", error);
              unityInstanceRef.SendMessage('TonConnectManager', 'OnError', JSON.stringify(error));
          });
      }
  ...
  function _OpenWallet(){
          console.log("Open Wallet Call");
  
          tonConnectInstance.openWallet().then(result => {
              console.log("Open wallet result:", result);
              unityInstanceRef.SendMessage('TonConnectManager', 'OnOpenWallet', JSON.stringify(result));
          }).catch(error => {
              unityInstanceRef.SendMessage('TonConnectManager', 'OnError', JSON.stringify(error));
          });
      }

  function _SendGame(chatIdPtr, gameShortNamePtr){
      if (TelegramBotInstance === null) {
        console.error("Bot instance is not initialized.");
        return;
      }
  
      console.log("SEND GAME CALL");
  
      var chatId = parseInt(UTF8ToString(chatIdPtr));
      var gameShortName = UTF8ToString(gameShortNamePtr);
  
      console.log("Chat ID Pointer:", chatIdPtr);
      console.log("Game Short Name Pointer:", gameShortNamePtr);
  
      console.log("Chat ID:", chatId);
      console.log("Game Short Name:", gameShortName);
      
      TelegramBotInstance.sendGame(chatId, gameShortName).then(result => {
        console.log("Game Sent:", result);
        unityInstanceRef.SendMessage( "TelegramBotManager", "OnSendGame", JSON.stringify(result) );
      }).catch(error => {
  ...
  function _SendInvoice(chatIdPtr, starPtr){
      ...
      TelegramBotInstance.sendInvoice(chatId, star).then( result => {
        ...
        unityInstanceRef.SendMessage( "TelegramBotManager", "OnSendInvoice", JSON.stringify(result) );
      }).catch(error => {
  ...
  function _SendTelegramMessage(chatIdPtr, messagePtr) {
      if (TelegramBotInstance === null) {
        console.error("Bot instance is not initialized.");
        return;
      }
      ...
      TelegramBotInstance.sendMessage(chatId, message).then(result => {
        console.log("Message sent:", result);
        unityInstanceRef.SendMessage("TelegramBotManager", "OnSendTelegramMessage", JSON.stringify(result));  
      }).catch(error => {
  ...
  function _SendTransaction(tonAddressPtr, tonAmountPtr, tonPayloadPtr){
          console.log("Call SendTransaction");
  
          var tonAddress = UTF8ToString(tonAddressPtr);
          var tonAmount = UTF8ToString(tonAmountPtr);
          var tonPayload = UTF8ToString(tonPayloadPtr);
  
          console.log("Address:", tonAddress);
          console.log("Ton Amount:", tonAmount);
  
          tonConnectInstance.sendTransaction(tonAddress, tonAmount, tonPayload).then(result => {
              console.log("Send Transaction result:", result);
              unityInstanceRef.SendMessage('TonConnectManager', 'OnSendTransaction', JSON.stringify(result));
          }).catch(error => {
              unityInstanceRef.SendMessage('TonConnectManager', 'OnError', JSON.stringify(error));
          });
      }

  function _SetGameScore(userIdPtr, scorePtr, chatIdPtr, messageIdPtr){
      if (TelegramBotInstance === null) {
        console.error("Bot instance is not initialized.");
        return;
      }
      ...
      TelegramBotInstance.setGameScore(userId, score, chatId, messageId ).then( result => {
          console.log( "Set score: ", result );
          unityInstanceRef.SendMessage("TelegramBotManager", "OnSetGameScore", JSON.stringify(result));  
      }).catch(error => {
          console.error("Failed to set score:", error);
          unityInstanceRef.SendMessage("TelegramBotManager", "OnError", JSON.stringify(error));  
      });
  ...
  function _SetUserInfo(userIdPtr, messageIdPtr){
      console.log("Set User Info Call");
  
      var userId = parseInt(UTF8ToString(userIdPtr));
      var messageId = UTF8ToString(messageIdPtr);
  
      console.log("User ID:", userId);
      console.log("Message ID:", messageId);
  
      TelegramBotInstance.setUserInfo( userId, messageId );
    }
...
var asmLibraryArg = {
  ...
  "IsConnectWallet": _IsConnectWallet,
