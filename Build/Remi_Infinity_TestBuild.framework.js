 ...
 7162542: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _ConnectWallet(){
          ...
          tonConnectInstance.connectWallet().then(result => {
              ...
              unityInstanceRef.SendMessage('TonConnectManager', 'OnWalletConnected', JSON.stringify(result));  
          }).catch(error => {
  ...
  function _GetGameHighScores(userIdPtr, chatIdPtr, messageIdPtr){
      ...
      console.log("GET GAME High score");
        ...
        TelegramBotInstance.getGameHighScores(userId, chatId, messageId ).then( result => {
            ...
            unityInstanceRef.SendMessage("TelegramBot", "OnGetGameHighScores", JSON.stringify(result));  
        }).catch(error => {
  ...
  function _SendTelegramMessage(chatIdPtr, messagePtr) {
      ...
      TelegramBotInstance.sendMessage(chatId, message).then(result => {
        ...
        unityInstanceRef.SendMessage("TelegramBot", "OnSendTelegramMessage", JSON.stringify(result));  
      }).catch(error => {
  ...
  function _SetGameScore(userIdPtr, scorePtr, chatIdPtr, messageIdPtr){
      ...
      TelegramBotInstance.setGameScore(userId, score, chatId, messageId ).then( result => {
          ...
          unityInstanceRef.SendMessage("TelegramBot", "OnSetGameScore", JSON.stringify(result));  
      }).catch(error => {
          console.error("Failed to set score:", error);
          unityInstanceRef.SendMessage("TelegramBot", "OnError", JSON.stringify(error));  
      });
